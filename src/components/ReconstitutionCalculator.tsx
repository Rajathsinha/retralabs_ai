        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2.5 border-2 border-slate-300 rounded-lg focus:outline-none focus:border-emerald-500 text-base font-semibold bg-white"
                    placeholder="10"
                    step="0.1"
                  />
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="px-3 py-2.5 border-2 border-slate-300 rounded-lg focus:outline-none focus:border-emerald-500 text-sm font-bold bg-white text-slate-700 cursor-pointer"
                  >
            ...
            <details className="group">
              <summary className="cursor-pointer text-sm font-semibold text-slate-700 hover:text-emerald-600 transition-colors flex items-center gap-2 py-2">
                <span className="text-emerald-500 group-open:rotate-90 transition-transform inline-block">&#9654;</span>
                How to Use
              </summary>
