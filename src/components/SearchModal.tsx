...
const DEMO: ProductWithVariants[] = [
  ...
  },
  {
    ...
    image_url: '/semax.jpg', created_at: '',
    variants: [{ id: '4a', product_id: '4', dosage_mg: 20, price_inr: 3000, in_stock: true, created_at: '' }],
  },
  {
    ...
    image_url: '/selank.jpg', created_at: '',
    variants: [{ id: '5a', product_id: '5', dosage_mg: 20, price_inr: 3000, in_stock: true, created_at: '' }],
  },
  {
