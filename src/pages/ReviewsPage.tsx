...
const communityReviews = [
  ...
  },
  {
    ...
    body: "My first order landed in just 9 days, but the second one took a chill 22 days. No biggie — I had enough stock to keep me going. Within just 3 hours I felt the reta's magic. I had tried some random IndiaMART seller's reta — total fake, useless piece of junk. I was desperate for the real stuff and RetraLabs totally came through.",
    product: 'Retatrutide',
  },
  {
    ...
    body: "Posting this because I know how sketchy this space is, especially in India. Honestly, I was very skeptical at first. I had already been scammed earlier via an Indiamart seller (fake Peptide Sciences vials, wasted ~7k), so trusting anyone again wasn't easy. I checked proof of purchase and results from another user, then directly contacted the retralabs number listed on their site. Quality is absolutely legit.",
    product: 'Retatrutide',
  },
];
            ...
            <CardBody className="relative p-10 text-center">
              ...
              <div className="relative">
                ...
                <p className="text-slate-400 mb-8 max-w-md mx-auto">
                  Your honest review helps other researchers dodge the scam market and find the real stuff. 2 minutes. Priceless for someone currently being scammed on IndiaMart.
                </p>
                <Button
                  as="a"
                  href="https://www.trustpilot.com/review/retralabs.in"
