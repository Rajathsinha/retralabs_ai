      ...
      <section className="relative overflow-hidden bg-slate-950 py-20">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-lg text-slate-400 leading-relaxed max-w-2xl mx-auto">
            India's research peptide market is still a mess of counterfeit sellers, IndiaMart listings, and zero accountability. We got scammed. Got angry. Built something better. One verified batch at a time.
          </p>
        </div>
      </section>
            ...
            <ScrollReveal>
              <div>
                ...
                <div className="space-y-5 text-slate-600 leading-relaxed">
                  <p>
                    In 2023, our founder — a researcher chasing GLP-1 compounds — spent months trying to source legitimate Retatrutide in India. Every IndiaMart seller, every Instagram "peptide shop" was either counterfeit, absurdly overpriced, or just ghosted after payment. Real money. Fake product. No accountability.
                  </p>
                  <p>
                      ...
                      <CardBody className="p-4">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-600">Indiamart sellers, fake Peptide Sciences vials, no COA, no accountability, ~₹7,000 lost to counterfeit products.</p>
                          </div>
                        </div>
                      </CardBody>
                    </Card>
