...
const HERO_HEADLINES = [
  {
    ...
    jsx: (
      <>
        We Got Scammed<br />
        on <span className="line-through text-slate-500">Ind**mart.</span><br />
        <span className="text-gradient">So We Built This.</span>
      </>
    ),
  },
  {
...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    rating: 5,
    text: "I was very skeptical — had already been scammed via an Indiamart seller (fake vials, wasted ~7k). After checking proof from another user, I took the gamble. Quality is absolutely legit.",
    product: 'Retatrutide',
  },
];
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Because the Alternative Is Ind**mart.</h2>
