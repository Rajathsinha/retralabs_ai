                  ...
                  >
                    <div className="aspect-[4/3] bg-slate-100 overflow-hidden relative">
                      ...
                      <Chip
                        size="sm"
                        variant="solid"
                        startContent={<ShieldCheck className="w-3.5 h-3.5 text-emerald-600" />}
                        classNames={{ base: 'absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-slate-800 shadow-sm' }}
                      >
                        VERIFIED
                      </Chip>
                    ...
                    <CardBody className="p-6">
                      <h3 className="text-2xl font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors duration-200">
                        {product.name}
                      </h3>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="flex items-center gap-1 text-sm font-semibold text-primary group-hover:gap-2 transition-all duration-200">
                          Details
                    ...
                    <CardFooter className="pt-0 pb-4 px-6 justify-center border-t border-slate-100 mx-6">
